...
signUserUp() async {
  ...
  try {
    ...
    if (passwordController.text == confirmPasswordController.text) {
      ...
      Navigator.pop(context); // Fechar o carregamento se a criação do usuário for bem-sucedido
    } else {
              ...
              children: [
               ...
               //Logo do app com borda arredondada
                ...
                const Text(
                  ...
                  style: TextStyle(color: Color(0xFF0F9E99), fontSize: 23, fontWeight: FontWeight.w400),
                ),
                const SizedBox(
                  height: 35,
                ),
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: Color(0xFF0F9E99), fontSize: 16,
                          ),
                        ),
                      ),
                      Expanded(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Text(
                        "Faça Login",
                        style: TextStyle(
                           color: Color(0xFF0F9E99), fontWeight: FontWeight.bold, fontSize: 17),
                      ),
                    ),
                  ],
                )
